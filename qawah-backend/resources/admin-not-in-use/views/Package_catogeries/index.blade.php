...
<div class="card card-primary card-outline">
          <div class="card-header">
           ...
           ?>
            ...
            <a href="{{url('admin/add-packages-catogeries')}}">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$lt->title}}</td>
                      <td>
                        <a href="{{route('Package_catogeries.edit',['id'=>$lt->id])}}"><i style="color: #c49f47;" class="fas fa-pen-square"></i></a> |
                        <a href="{{route('Package_catogeries.delete',['id'=>$lt->id])}}"><i style="color: #bd0a0a;" class="fa fa-trash" aria-hidden="true">
                        </i></a> 
