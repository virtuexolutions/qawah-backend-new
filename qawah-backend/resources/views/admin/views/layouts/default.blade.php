...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="{{ asset('adminTheme/plugins/fontawesome-free/css/all.min.css') }}">
<link rel="stylesheet" href="{{ asset('adminTheme/plugins/summernote/summernote.min.css') }}">
...
<div class="wrapper">
  @include('admin.views.layouts.header')

  <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #93652b!important">
    <!-- Brand Logo -->
...
<script src="{{ asset('adminTheme/plugins/summernote/summernote.min.js') }}"></script>

<script>		  
$(document).ready(function() {
  $('.summernoteee').summernote();
});
</script>
