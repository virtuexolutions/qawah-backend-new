    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{route('packages.store')}}" method="post" id="packges_form" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
			  <div class="row">
                <div class="col-md-6">
				...
				<div class="form-check form-switch form-check-inline">
                  <input class="form-check-input" name="promotion" type="checkbox" id="CheckPromotions" value="1">
                  ...
                  <div class="form-group">
				<div class="form-check form-switch form-check-inline">
                  <input class="form-check-input" name="most_popular" type="checkbox" id="Checkmost_popular" value="1">
        ...
        <input type="number" class="form-control" min="1" minlength="1" max="365" maxlength="365" name="duration"  placeholder="Duration"> 
