...
<div class="card card-primary card-outline">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
                <form action="{{route('promotions.update',$package->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
              ...
              <div class="row">
                ...
                <div class="col-md-6" id="Duration">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control"  name="duration" min="1" minlength="1" max="365" maxlength="365" value="{{$package->duration }}" placeholder="Duration">
