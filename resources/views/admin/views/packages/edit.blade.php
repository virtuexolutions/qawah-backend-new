...
<div class="card card-primary card-outline">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
                <form action="{{route('packages.update',$package->id)}}" id="packages_form" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
               ...
               <div class="card-body">
				...
				<div class="form-check form-switch form-check-inline">
                  <input class="form-check-input" name="promotion" type="checkbox" id="CheckPromotions"
						 value="1"  {{($package->promotion == 1)?'checked':''}}>
                  <label class="form-check-label" for="CheckPromotions">Promotional Package?</label>
                </div>
					</div>
				  </div>
				 <div class="col-md-6">
                  <div class="form-group">
				<div class="form-check form-switch form-check-inline">
                  <input class="form-check-input" name="most_popular" type="checkbox" id="Checkmost_popular" value="1" {{($package->most_popular == 1)?'checked':''}}>
                  <label class="form-check-label" for="Checkmost_popular">Most Popular?</label>
                </div>
					</div>
				  </div>
				</div>
              ...
              <div class="row">
                ...
                <div class="col-md-6" id="Duration">
                  <div class="form-group">
                    <label for="exampleInputPassword1">No Days</label>
					  <input type="number" class="form-control" min="1" minlength="1" max="365" maxlength="365" name="duration"  placeholder="Duration" value="{{$package->duration}}"> 
                ...
                <div class="col-md-6" id="premium_options">
                  <div class="form-group">
                    ...
                    <select class="form-control" id="" name="type">
                      <option value="" disabled>Select Permimum Options</option>						
              ...
              <div class="form-group" id="add_on">
                ...
                <div class="form-check form-check-inline">
                  ...
                  <input class="form-check-input" name="options[]" type="checkbox" id="inlineCheckbox9"
                    value="lovenotes" {{(isset($options['lovenotes'])=='lovenotes')?'checked':''}}>
                  <label class="form-check-label" for="inlineCheckbox9">Love Notes</label>
                </div>
              <div class="form-group">
                <label for="exampleInputPassword1">Description</label>
                <textarea class="summernoteee"  name="description">{{($package->description) ?:''}}</textarea>
              </div>
