...
<div class="card card-primary card-outline">
          <div class="card-header">
           ...
           ?>
            ...
            Add Details to  Promotion Packages Page
            </h3>
                  ...
                  <tbody>
                    ...
                    <tr>
					 ...
					 <td>
                      ...
                      <td>
						 @can('promotions-status') 
						  @if($pkg->active == 1)
						<a href="{{route('promotions_status',['id'=>$pkg->id,'status'=>'0'])}}">
							<i class="fa fa-times-circle" style="font-size:17px;color:red"></i>
						  </a>	
						@else
						 <a href="{{route('promotions_status',['id'=>$pkg->id,'status'=>'1'])}}">
						  <i class="fa fa-check" style="color:green"></i>
						  </a>						
						  @endif
						 @endcan
						   @can('promotions-edit')
                      |<a href="{{route('promotions.edit',$pkg->id)}}"><i style="color: #c49f47;" class="fas fa-pen-square"></i></a> |
						   @endcan
						   @can('promotions-delete')
						  <form method="post" action="{{route('promotions.destroy',$pkg->id)}}">
							 @csrf
							  @method('DELETE')
