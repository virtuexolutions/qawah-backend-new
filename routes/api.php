...
// });
//Saad code
Route::POST('/auth/register/app',[App\Http\Controllers\ApiControllers\Auth\RegisterController::Class,"add_new"]);
...
// });
  ...
  Route::group(["middleware" => "auth:api"],function(){ 
	...
	Route::get('/seeking/youaretheretype',[App\Http\Controllers\ApiControllers\SeekingController::Class,"youaretheretype"]);
	Route::POST('/user/update-my-profile-image',[App\Http\Controllers\ApiControllers\UsersController::Class,"update_profile_image"]); 
	Route::POST('/user/update-my-gallery-image',[App\Http\Controllers\ApiControllers\UsersController::Class,"update_gallery_image"]); 
	Route::POST('/user/post-gallery-image',[App\Http\Controllers\ApiControllers\UsersController::Class,"post_gallery_image"]); 
	
	Route::get('/view_notication',[App\Http\Controllers\ApiControllers\SettingsController::Class,"view_notications_app"]);
